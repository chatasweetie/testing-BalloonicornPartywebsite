...
def most_and_least_common_type(treats):
    ...
    Generic test
    >>> treats = {'type': 'appetizer', 'description': 'Mini-enchiladas', 'who': 'David'},{'type':'drink', 'description':'Sangria', 'who': 'Kari'},{'type':'appetizer', 'description':'Hemuboldt Fog cheese', 'who':'Meggie'}
    >>> most_and_least_common_type(treats)
    ('appetizer', 'drink')

    Testing if dictionary has a tie for most and least
    >>> treats = {'type': 'appetizer', 'description': 'Mini-enchiladas', 'who': 'David'},{'type':'drink', 'description':'Sangria', 'who': 'Kari'}
    >>> most_and_least_common_type(treats)
    ('drink', 'drink')

    Testing if dictionary has only one type of food
    >>> treats = {'type': 'appetizer', 'description': 'Mini-enchiladas', 'who': 'David'},{'type':'appetizer', 'description':'Hemuboldt Fog cheese', 'who':'Meggie'}
    >>> most_and_least_common_type(treats)
    ('appetizer', 'appetizer')
